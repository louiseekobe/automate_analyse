...
def show():
    ...
    if selected_fmp_col_01:
        ...
        if st.button("Selctionner le point de suivi des flux"): 
            df_fmr_filtered = df_fmr[df_fmr[selected_fmp_col_01] == selected_fmp_value_01]
            df_merged_filtered = df_merged[df_merged[selected_fmp_col_01] == selected_fmp_value_01]
    else:
